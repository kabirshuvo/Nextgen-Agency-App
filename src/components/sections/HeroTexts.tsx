...
const HeroTexts: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
        <h1
          className="h1 hover:text-popover transition duration-300 ease-in-out transform hover:scale-105 relative"
        ...
        <h1
          className={`hiddenh1 absolute inset-0 flex justify-center items-center md:justify-start transition-opacity duration-300 ease-in-out ${
